...
export class ProjectsComponent implements OnChanges {
  ...
  allProjects = [
    ...
    { id: 4, name: 'WorldWise', source: `${this.path}/worldwise.png`, github: 'https://github.com/abdelaleemadel/WorldWise', live: 'https://world-wise-eta-seven.vercel.app/', ready: true },
